        ...
        <div>
            <div className="flex flex-col w-80 mx-auto">
                ...
                <div className="flex flex-col mx-auto mt-2 w-80 h-40 bg-white shadow-gray-500 shadow-md items-center text-center text-black">
                    ...
                    <div className="flex flex-row space-x-3 text-[10px] text-gray-500 mt-4 justify-center items-center text-center">
                        <div className="flex flex-row">
                            <input type="radio" name="plan" value="Procure Pin" />
                            <p className="ml-[2px]">Procure Pin</p>
                        </div>
                        <div className="flex flex-row">
                            <input type="radio" name="plan" value="Retrieve Pin" />
                            <p className="ml-[2px]">Retrieve Pin</p>
                        </div>
                    </div>
                    <div className="flex flex-col justify-center items-center text-center text-black mt-4 text-[8px] font-medium">

    ...
    return (
        <div>
            <div className="flex flex-col w-80 mx-auto">
                ...
                <p className="text-black justify-center items-center text-center mt-2 text-sm">Transfer funds to another user on TranzGO</p>
                <p className="text-green-600 justify-center items-center text-center mt-3 text-md font-bold">TranzGO ID</p>

    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-center justify-center mt-28 flex-shrink">
                ...
                <div className="flex flex-row items-center justify-center text-center text-green-600 font-bold bg-white hover:bg-green-100 py-2 w-96 h-10 rounded-2xl border-solid border-2 border-green-600 mb-7">
                ...
                <div className="flex flex-row items-center justify-center text-center text-green-600 font-bold bg-white hover:bg-green-100 py-2 w-96 h-10 rounded-2xl border-solid border-2 border-green-600 mb-8">
